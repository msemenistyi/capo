var fs = require('fs'),
	...
	path = require('path'),
	async = require('async'),
	GitIgnoreHelper = require('./GitIgnoreHelper'),
...
Capo.prototype.generateGitExcludes = function(filePath) {
	var gitIgnoreHelper = new GitIgnoreHelper({
		path: filePath
	});
	return gitIgnoreHelper.parse();
};